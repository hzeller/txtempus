...
/*static*/ const uint32_t GPIO::kValidBits =
    ((1 << 0) | (1 << 1) |  // RPi 1 - Revision 1 accessible
     ...
     (1 << 14) | (1 << 15) | (1 << 17) | (1 << 18) | (1 << 22) | (1 << 23) |
     (1 << 24) | (1 << 25) | (1 << 27) |
     // support for A+/B+ and RPi2 with additional GPIO pins.
     (1 << 5) | (1 << 6) | (1 << 12) | (1 << 13) | (1 << 16) | (1 << 19) |
     (1 << 20) | (1 << 21) | (1 << 26));
...
double GPIO::StartClock(double requested_freq) {
  ...
  for (size_t i = 0; i < sizeof(kClockSources) / sizeof(kClockSources[0]);
       ++i) {
...
static RaspberryPiModel DetermineRaspberryModel() {
  ...
  switch (pi_type) {
    ...
    case 0x11: /* Pi 4 */
      ...
      fprintf(stderr,
              "Note: Frequency generation is known to not work on Pi4; "
